...
class Edge(Common):
    ...
    def __eq__(self, edge):
        ...
        if self.get_parent_graph().get_top_graph_type() == 'graph':
            ...
            return self.get_source() == edge.get_source() and self.get_destination() == edge.get_destination()
...
class Graph(Common):
    ...
    def get_suppress_disconnected(self, _):
